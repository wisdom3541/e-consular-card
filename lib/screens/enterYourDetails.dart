...
// import 'package:e_consular_card/screens/enterYourDetails2.dart';
...
// Widget selectPhotoForm(BuildContext context, UpdateNinDataProvider undp) {
//   return Column(
//     crossAxisAlignment: CrossAxisAlignment.start,
//     children: [
//       SizedBox(
...
//         height: 10.h,
//       ),
//       Consumer<UpdateNinDataProvider>(
//         builder: (context, undp, child) {
//           return undp.passportImage != null
//               ? Container(
//                   width: 150,
//                   height: 150,
...
//                       image: FileImage(undp.passportImage!),
//                       fit: BoxFit.cover,
//                     ),
//                   ),
//                 )
...
//           var selcetedImage = await pickAndResizeImage(true);
...
//                 undp.firstnameController, ap.editableField),
//             const SizedBox(
//               height: 20,
//             ),
//             textFieldForForm("Last Name*", "Enter your last name", "Required",
//                 undp.surnameController, ap.editableField),
//             const SizedBox(
//               height: 20,
//             ),
//             textFieldForForm("Middle Name*", "Enter your middle name",
//                 "Optional", undp.middlenameController, ap.editableField),
//             const SizedBox(
//               height: 20,
//             ),
...
//                 onPressed: () {
//                   //  print("rerer${ap.isBirthCertImageRequired}");
//                   print("rerewewewr${ap.ninRegisteration}");
//                   print("wwewewew${ap.editableField}");

//                   if (_formKey.currentState?.validate() == true &&
//                       undp.passportImage != null) {
...
//                   //  bool isImageRequired = !ap.ninRegisteration;
...
// Future<File?> pickAndResizeImage(bool nin) async {
//   final picker = ImagePicker();
//   final pickedFile = await picker.pickImage(source: ImageSource.gallery);
...
//   // 🔑 Use timestamp to generate unique file name
//   String finalNameHeader = nin ? "resized_passport_" : "ceritificate_";
//   final fileName =
//       '$finalNameHeader${DateTime.now().millisecondsSinceEpoch}.jpg';

//   final resizedFile = File(join(tempDir.path, fileName))
