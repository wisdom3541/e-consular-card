...
import 'package:e_document_request/screens/paymentScreen.dart';
...
var bottomNavDestination = const [
  ...
  NavigationDestination(
      ...
      label: "Dashboard"),
  NavigationDestination(
      icon: Icon(Icons.payments_outlined, fill: 1, color: Color(0xFF24985B)),
      label: "Payment"),
  NavigationDestination(
