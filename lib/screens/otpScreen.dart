...
//           undp.populateRetrievedData();
//         } else if(!ap.ninRegisteration) {
//           undp.populateWithoutNinData();
//         }
...
//                       if (value == null ||
//                           value.length < 6 ||
//                           value != op.otp.toString()) {
//                         return 'Enter the 6-digit OTP ${op.otp} ';
//                       }
//                       return null;
//                     },
...
//                 Text(
//                   "Didn’t receive the 6 digit code ? ${op.otp} ",
//                   style: TextStyle(
//                     fontSize: 12,
//                     fontWeight: FontWeight.w400,
//                     color: Colors.grey,
